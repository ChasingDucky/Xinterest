    ...
    <Box
      sx={{
        ...
        background: `
          ...
          radial-gradient(ellipse at bottom left, ${alpha(monetPalette.pondGreen, 0.15)}, transparent 50%),
        ...
        '&::before': {
          ...
          bottom: 0,
          backgroundImage: `
            radial-gradient(circle at 20% 50%, ${alpha(monetPalette.roseAccent, 0.08)} 0%, transparent 50%)
          `,
